...
\adddoublerow{dtCode}{a datatype which generates the code}
\adddoubletwocolumnrow{attribute}{\msrcode{generatedCode: dtString}}{an attribute in dtString in which the code is stored}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to determine which strings are considered as valid generated codes.}
...
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to determine which litteral belongs to the enumeration.}
\adddoublerow{etGeographicalLocation}{this type is used to indicate the different types of geographical locations.}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to determine which litteral belongs to the enumeration.}
