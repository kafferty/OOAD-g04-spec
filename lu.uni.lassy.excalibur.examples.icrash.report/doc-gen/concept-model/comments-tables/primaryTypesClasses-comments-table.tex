...
\adddoubletwocolumnrow{operation}{\msrcode{init(Alogin:dtLogin, Apwd:dtPassword, AphoneNumber:dtPhoneNumber):ptBoolean}}{used to initialize the current object as a new instance of the ctAdministrator type.}
...
\adddoubletwocolumnrow{operation}{\msrcode{init(Aid:dtAlertID, Astatus:etAlertStatus, Alocation:dtGPSLocation, Ainstant:dtDateAndTime, Acomment:dtComment, AcrisisType:etCrisisType):ptBoolean}}{used to initialize the current object as a new instance of the ctAlert type.}
...
\adddoubletwocolumnrow{attribute}{\msrcode{phoneNumber: dtPhoneNumber}}{use for identifing a user phone number}
...
\adddoubletwocolumnrow{attribute}{\msrcode{vpIsLoggedStep1: ptBoolean}}{used to determine the correctness of password and login.}
\adddoubletwocolumnrow{operation}{\msrcode{init(Alogin:dtLogin, Apwd:dtPassword, AphoneNumber:dtPhoneNumber):ptBoolean}}{used to initialize the current object as a new instance of the ctAuthenticated type.}
...
\addsingletwocolumnrow{extends}{icrash.concepts.primarytypes.classes.ctAuthenticated}
\adddoubletwocolumnrow{attribute}{\msrcode{crisisType: etCrisisType}}{used to inentify crisisType for which coordinator is assigned.}
\adddoubletwocolumnrow{attribute}{\msrcode{geographicalLocation: etGeographicalLocation}}{used to inentify geographical location for which coordinator is assigned.}
\adddoubletwocolumnrow{attribute}{\msrcode{id: dtCoordinatorID}}{a unique identification information.}
\adddoubletwocolumnrow{operation}{\msrcode{init(Aid:dtCoordinatorID, Alogin:dtLogin, Apwd:dtPassword, AphoneNumber:dtPhoneNumber, AgeographicalLocation:etGeographicalLocation, AcrisisType:etCrisisType):ptBoolean}}{used to initialize the current object as a new instance of the ctCoordinator type.}
