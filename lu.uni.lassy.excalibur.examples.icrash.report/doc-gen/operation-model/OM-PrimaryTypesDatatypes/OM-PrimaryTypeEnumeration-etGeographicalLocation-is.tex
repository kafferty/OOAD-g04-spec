...
The \msrcode{is} operation has the following properties:
	...
	\addnumberedsinglerow{PostF}{true iff the value is equal to one of the following values: \msrcode{central, southWestern, northWestern, southEastern, northEastern}}
