...
The \msrcode{oeSetCrisisType} operation has the following properties:
	...
	\adddoublerow{oeSetCrisisType}{sent to define the gravity type of a specific crisis and alert which is associated with this crisis.}
	...
	\addnumberedsinglerow{PostF}{the crisis type attribute of the crisis  instance having the given id is replaced by the given one. the crisis type attribute of the alert insanse that is associated with current crisis is replaced by the given one. the requesting actor is notified of this update.}
