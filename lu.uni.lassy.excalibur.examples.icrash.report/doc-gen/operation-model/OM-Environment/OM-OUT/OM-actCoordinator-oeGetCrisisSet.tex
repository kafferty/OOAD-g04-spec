...
The \msrcode{oeGetCrisisSet} operation has the following properties:
	...
	\adddoublerow{oeGetCrisisSet}{sent to request all the ctCrisis instances having a specific status, crisis type and geographical location .}
