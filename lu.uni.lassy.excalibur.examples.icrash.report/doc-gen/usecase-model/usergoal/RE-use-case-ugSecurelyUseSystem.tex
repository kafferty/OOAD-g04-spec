...
\addnumberedsinglerow{}{\msrucname{oeSMS [1..1]}}
...
\addalphanumberedsinglerow{}{the actor \msrcode{actAuthenticated} executes the \msrucname{oeSMS} use case}
\addrowheading{Steps Ordering Constraints}
\addnumberedsinglerow{}{step (a) must always precede step (c). step (c) must always precede step(b). }
