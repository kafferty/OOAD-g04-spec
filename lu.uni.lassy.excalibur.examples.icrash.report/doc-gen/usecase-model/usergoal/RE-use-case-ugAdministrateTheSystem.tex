...
\addnumberedsinglerow{}{\msrucname{oeEditCoordinator [0..*]}}
...
\addalphanumberedsinglerow{}{the actor \msrcode{actAdministrator} executes the \msrucname{oeEditCoordinator} use case}
...
\addnumberedsinglerow{}{steps (a) (b) (c) and (d) executions are interleaved 
          (steps (b) and (c) have their protocol constrained 
           by steps of (a)).}
\addnumberedsinglerow{}{steps (a) (b) (c) and (d) can be executed multiple times.}
